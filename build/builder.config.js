  ...
  const files = [
    {
      ...
      output: path.resolve(__dirname, '../../vueform-builder/packages/vueform-production/dist/installer.js'),
      lock: true,
    },
    {
      input: path.resolve(__dirname, '../dist/element.js'),
      output: path.resolve(__dirname, '../../vueform-builder/packages/vueform-production/dist/element.js'),
      lock: true,
    },
  ]
