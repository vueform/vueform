...
import { disables, min, max } from './optionsDate'
...
export const displayFormat = function (elementType, elementName, options) {
  ...
  testComputedOption(it, elementType, 'displayFormat', form.vm.__('laraform.elements.time.displayFormat'), 'mm:HH')
...
export const valueFormat = function (elementType, elementName, options) {
  testComputedOption(it, elementType, 'valueFormat', 'HH:mm', 'mm:HH')
...
export const loadFormat = function (elementType, elementName, options) {
  testComputedOption(it, elementType, 'loadFormat', 'HH:mm', 'HH:mm')
