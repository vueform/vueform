  ...
  it('should work with `yesterday`', async () => {
    let form = createForm({
      schema: {
        a: {
          type: 'text',
          rules: 'before_or_equal:yesterday',
        }
      }
    })
  ...
  it('should work with `tomorrow`', async () => {
    let form = createForm({
      schema: {
        a: {
          type: 'text',
          rules: 'before_or_equal:tomorrow',
        }
      }
    })
  ...
  it('should work with `absolute` dates', async () => {
    let form = createForm({
      schema: {
        a: {
          type: 'date',
          rules: 'before_or_equal:25/12/2020',
    ...
    let form = createForm({
      schema: {
        a: {
          type: 'dates',
          mode: 'multiple',
          rules: 'before_or_equal:2020-12-26'
        }
      }
    })
