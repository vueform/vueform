...
describe('Exists Rule', () => {
  it('should be valid if endpoints return true', (done) => {
  ...
  it('should be invalid if endpoints return false', (done) => {
    const LocalVue = createLocalVue()
  ...
  it('should replace params with field values after first param', (done) => {
    const LocalVue = createLocalVue()
