...
describe('Text Element Rendering', () => {
  ...
  it('should render component attributes', async () => {
    let form = createForm({
      schema: {
        a: {
          type: 'text',
    ...
    expect(_.keys(a.get('input').attributes())).toContain('disabled')
    expect(_.keys(a.get('input').attributes())).toContain('readonly')
  ...
  it('should render floating label', async () => {
    ...
    let a = findAllComponents(form, { name: 'TextElement' }).at(0)
    let elf = findAllComponents(a, { name: 'ElementLabelFloating' }).at(0)
  ...
  //   let a = findAllComponents(form, { name: 'TextElement' }).at(0)
  //   let mi = findAllComponents(a, { name: 'MaskedInput' }).at(0)
