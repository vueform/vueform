  ...
  "vueform": {
    "elements": {
      ...
      "signature": {
        ...
        "upload": "업로드",
        "font": "글꼴 선택",
        "fontPlaceholder": "당신의 이름",
        "placeholder": "여기에 서명",
        "unsupportedFormat": "지원되지 않는 파일 형식입니다. 수락되는 확장자는: :extensions",
        "maxSizeError": "최대 파일 크기는 :max KB입니다",
        "imgAlt": "서명",
        "imgTitle": "서명",
        "undo": "실행 취소",
        "redo": "다시 실행",
        "dnd": "여기에 이미지를 드롭하거나",
        "uploadButton": "이미지 선택",
        "modeSelectorAriaLabel": "서명 모드 선택",
        "fontSelectorAriaLabel": "글꼴 선택",
        "wrapperAriaLabel": "서명 입력",
        "inputAriaLabel": "여기에 서명을 입력하세요",
        "padAriaLabel": "상자에 서명을 그리세요. 필요하면 도움을 받으세요.",
        "clearAriaLabel": "서명 지우기",
