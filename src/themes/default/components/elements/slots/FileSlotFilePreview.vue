    ...
    data() {
      return {
        defaultClasses: {
          ...
          warning: 'form-file-preview-file-warning',
          warningIcon: 'form-file-preview-file-warning-icon',
          uploaded: 'form-file-preview-file-uploaded',
          uploadedIcon: 'form-file-preview-file-uploaded-icon',
          remove: 'form-file-preview-file-remove',
          removeIcon: 'form-file-preview-file-remove-icon',
        }
      }
    }
  }
...
<style lang="scss">
  .form-file-preview-file {
    ...
    &:hover {
      .form-file-preview-file-uploaded,
      .form-file-preview-file-warning,
  ...
  .form-file-preview-file-warning-icon, 
  .form-file-preview-file-uploaded-icon, 
  .form-file-preview-file-remove-icon {
    width: 100%;
    height: 100%;
    display: block;
