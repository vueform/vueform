    ...
    data() {
      return {
        defaultClasses: {
          container: '',
          list: '',
          list_file: 'form-multifile-list-file',
          list_image: 'form-multifile-list-image',
          list_gallery: 'form-multifile-list-gallery',
          list_disabled: 'is-disabled',
          list_sorting: 'is-sorting',
          spacer: 'form-multifile-spacer',
          listItem: '',
          listItem_file: 'form-row',
          listItem_image: 'form-row',
          listItem_gallery: 'form-multifile-list-item-gallery',
          handle: '',
...
<style lang="scss">
  ...
  .form-multifile-list-file,
  .form-multifile-list-image {
    & > .form-row {
      position: relative;

      &:hover {
        .form-multifile-handle-file,
        .form-multifile-handle-image {
          visibility: visible;
          opacity: 1;
        }
      }
  ...
  .form-multifile-list-image {
    margin-top: calc(var(--form-gutter) / 2);
  }

  .form-multifile-list-gallery {
    display: flex;
    flex-wrap: wrap;
    margin-top: calc(var(--form-gutter) / 2);
    margin-bottom: calc(var(--form-gutter) / 2);
