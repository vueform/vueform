    ...
    data() {
      return {
        defaultClasses: {
          ...
          handleIcon: '',
          handleIcon_file: 'form-multifile-handle-icon-file',
          handleIcon_image: 'form-multifile-handle-icon-image',
          handleIcon_gallery: 'form-multifile-handle-icon-gallery',
...
<style lang="scss">
  ...
  .form-multifile-handle-icon-file,
  .form-multifile-handle-icon-image {
    display: flex;
    align-items: center;
  ...
  .form-multifile-handle-icon-gallery {
    display: flex;
    align-items: center;
    justify-content: center;
    background-repeat: no-repeat;
