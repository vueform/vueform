<script>
  ...
  export default {
    ...
    methods: {
      ...
      /**
       * Helper method to create a name for a checkbox.
       *
       * @private
       * @param {str|num} key key of the checkbox.
       * @returns {void}
       */
      checkboxName(key) {
      ...
      /**
       * Helper method to create an ID for a checkbox.
       *
       * @private
       * @param {str|num} key key of the checkbox.
       * @returns {void}
      ...
      /**
       * Helper method which determines if a checkbox is disabled.
       *
       * @private
       * @param {str|num} key key of the checkbox.
       * @returns {void}
    ...
    created() {
      ...
      if (this.slots.checkbox === null) {
        this.slots.checkbox = this.theme.components.CheckboxgroupSlotCheckbox
      }
    },
  }
</script>