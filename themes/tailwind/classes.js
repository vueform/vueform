...
const editor = {
  container: '',
  input: 'form-border-input form-border-color-input form-shadow-input',
  input_enabled: '',
...
const select = {
  container: 'relative mx-auto w-full flex items-center justify-end box-border cursor-pointer form-shadow-input form-border-input form-border-color-input form-bg-input form-color-input outline-none',
...
export default {
  ...
  ButtonElement: {
    container: '',
    button: 'inline-block transition form-border-btn form-shadow-btn focus:outline-none',
  ...
  CheckboxElement: {
    ...
    input: checkbox.input + ' form-shadow-input focus:form-ring-input-shadow',
  ...
  FileElement: {
    ...
    button: 'form-border-btn form-shadow-btn inline-block transition focus:outline-none',
  ...
  ListElement: {
    ...
    add: 'inline-block form-bg-primary form-border-btn form-border-color-primary form-color-on-primary form-shadow-btn transition-transform transform hover:scale-105 focus:form-ring-btn-shadow',
  ...
  MultifileElement: {
    ...
    button_enabled: 'form-bg-btn-secondary form-color-btn-secondary form-border-color-btn-secondary form-shadow-btn cursor-pointer transition-transform transform hover:scale-105 focus:form-ring-btn-shadow',
    button_disabled: 'opacity-50 cursor-not-allowed',
  ...
  MultiselectElement: {
    container: '',
    input: 'w-full form-p-input form-border-input form-border-color-input form-shadow-input',
  ...
  RadioElement: {
    ...
    text: 'cursor-pointer',
    input: radio.input + ' form-shadow-input focus:form-ring-input-shadow',
  ...
  SelectElement: {
    container: '',
    input: 'w-full form-border-input form-border-color-input form-shadow-input',
    input_enabled: 'form-bg-input form-color-input focus:form-ring-input-shadow',
    input_disabled: 'form-bg-disabled form-color-disabled',
    input_sm: 'form-p-input-sm form-rounded-sm form-text-sm',
    input_md: 'form-p-input form-rounded form-text',
  ...
  SliderElement: {
    ...
    slider: {
      ...
      base: 'form-shadow-input w-full h-full relative z-1 form-bg-passive rounded',
      ...
      tooltip: 'absolute block form-text-small font-semibold whitespace-nowrap py-1 px-1.5 min-w-5 text-center form-rounded-small border form-border-color-primary form-bg-primary form-color-on-primary transform h:-translate-x-1/2 h:left-1/2 v:-translate-y-1/2 v:top-1/2 merge-h:translate-x-1/2 merge-h:left-auto merge-v:-translate-x-4 merge-v:top-auto tt-focus:hidden tt-focused:block tt-drag:hidden tt-dragging:block',
  ...
  ToggleElement: {
    ...
    text: 'ml-2',
    toggle: {
      container: 'form-shadow-input inline-block rounded-full outline-none focus:form-ring-input-shadow',
  ...
  FormStepsControl: {
    button: 'form-border-btn form-shadow-btn focus:form-ring-btn-shadow focus:outline-none disabled:pointer-events-none disabled:opacity-60 disabled:cursor-not-allowed',
  ...
  DragAndDrop: {
    container: 'form-shadow-input w-full form-bg-input form-color-input border border-dashed transition inline-flex flex-col items-center justify-center p-6 cursor-pointer',
