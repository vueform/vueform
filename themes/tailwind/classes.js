...
const checkbox = {
  input: 'flex-shrink-0 appearance-none bg-white transition duration-200 ease-in-out cursor-pointer form-border-input form-border-color-input mr-1.5 focus:form-ring checked:form-bg-check-white checked:border-0',
...
const radio = {
  input: 'flex-shrink-0 appearance-none bg-white transition duration-200 ease-in-out cursor-pointer rounded-full form-border-input form-border-color-input mr-1.5 focus:form-ring checked:form-bg-radio-white checked:border-0',
  input_enabled: 'checked:form-bg-primary',
  input_disabled: 'form-bg-disabled checked:form-border-input checked:form-border-color-input',
...
const editor = {
  input: 'form-border-input form-border-color-input',
  input_enabled: '',
...
const select = {
  container: 'relative mx-auto w-full flex items-center justify-end box-border cursor-pointer form-border-input form-border-color-input bg-white text-base leading-snug outline-none',
  ...
  dropdown: 'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full form-border-input form-border-color-input -mt-px overflow-y-scroll z-50 bg-white flex flex-col',
  ...
  groupLabelSelectedDisabled: 'text-white form-bg-primary-darker opacity-50 cursor-not-allowed',
  ...
  optionSelectedDisabled: 'text-white form-bg-primary opacity-50 cursor-not-allowed',
...
const groupTabs = {
  ...
  wrapper_selected: 'form-bg-primary text-white border-black border-opacity-15',
...
export default {
  ...
  ButtonElement: {
    container: '',
    button: 'inline-block transition focus:outline-none',
    ...
    button_primary: 'form-bg-btn form-color-btn',
    button_secondary: 'form-bg-btn-secondary form-color-btn-secondary',
    button_danger: 'form-bg-btn-danger form-color-btn-danger',
    button_sm: 'form-p-button-sm form-rounded-sm form-text-sm',
    button_md: 'form-p-button form-rounded form-text',
    button_lg: 'form-p-button-lg form-rounded-lg form-text-lg',
  ...
  ListElement: {
    ...
    add: 'inline-block form-bg-primary text-white transition-transform transform hover:scale-105',
  ...
  MultifileElement: {
    ...
    button_enabled: 'bg-gray-100 cursor-pointer hover:bg-gray-200',
    button_disabled: 'opacity-50 bg-gray-100 cursor-not-allowed',
    button_sm: 'form-mb-0.5gutter-sm form-p-button-sm form-rounded-sm form-text-sm',
    button_md: 'form-mb-0.5gutter form-p-button form-rounded form-text',
    button_lg: 'form-mb-0.5gutter-lg form-p-button-lg form-rounded-lg form-text-lg',
  ...
  MultiselectElement: {
    container: '',
    input: 'w-full form-p-input form-border-input form-border-color-input',
    input_enabled: 'focus:form-ring',
    input_disabled: 'form-bg-disabled form-color-disabled',
    input_sm: 'form-p-input-sm form-large-rounded-sm form-text-sm',
    input_md: 'form-p-input form-large-rounded form-text',
  ...
  SelectElement: {
    container: '',
    input: 'w-full form-border-input form-border-color-input',
    input_enabled: 'focus:form-ring',
    input_disabled: 'form-bg-disabled form-color-disabled',
    input_sm: 'form-p-input-sm form-rounded-sm form-text-sm',
    input_md: 'form-p-input form-rounded form-text',
  ...
  SliderElement: {
    ...
    slider: {
      ...
      handle: 'absolute rounded-full bg-white border-0 shadow-slider cursor-grab focus:outline-none h:w-4 h:h-4 h:-top-1.5 h:-right-2 txt-rtl-h:-left-2 txt-rtl-h:right-auto v:w-4 v:h-4 v:-bottom-2 v:-right-1.25 focus:form-ring disabled:cursor-not-allowed',
      touchArea: 'h-full w-full',
      tooltip: 'absolute block form-small-text font-semibold whitespace-nowrap py-1 px-1.5 min-w-5 text-center text-white form-small-rounded border form-border-color-primary form-bg-primary transform h:-translate-x-1/2 h:left-1/2 v:-translate-y-1/2 v:top-1/2 merge-h:translate-x-1/2 merge-h:left-auto merge-v:-translate-x-4 merge-v:top-auto tt-focus:hidden tt-focused:block tt-drag:hidden tt-dragging:block',
  ...
  TagsElement: {
    ...
    select: {
      ...
      tag: 'form-bg-primary text-white font-semibold py-px pl-2 mr-1 mb-1 flex items-center whitespace-nowrap',
      tag_sm: 'form-tag-rounded form-small-text-sm',
      tag_md: 'form-tag-rounded form-small-text',
      tag_lg: 'form-tag-rounded form-small-text-lg',
      ...
      tagsSearch: 'absolute inset-0 border-0 outline-none appearance-none p-0 box-border w-full',
  ...
  ToggleElement: {
    ...
    toggle: {
      ...
      toggleOn: 'form-bg-primary form-border-color-primary justify-start text-white',
      toggleOff: 'bg-gray-300 border-gray-300 justify-end text-gray-700',
      toggleOnDisabled: 'form-bg-primary form-border-color-primary opacity-50 justify-start text-white cursor-not-allowed',
  ...
  // Components
  ElementAddon: {
    container: 'form-border-input form-border-color-input bg-gray-100 flex items-center',
  ...
  FormStepsControl: {
    ...
    button_previous_enabled: 'text-gray-700 bg-gray-200 transition-transform transform hover:scale-105',
    button_previous_disabled: 'text-gray-700 bg-gray-200 opacity-60 pointer-events-none',
    button_next_enabled: 'form-bg-primary text-white transition-transform transform hover:scale-105',
    ...
    button_finish_enabled: 'form-bg-primary text-white transition-transform transform hover:scale-105',
  ...
  FormTab: {
    ...
    wrapper_active: 'border form-border-color-input !form-border-b-white',
    wrapper_inactive: 'border border-white form-border-b-color-input',
    wrapper_valid: '',
  ...
  DragAndDrop: {
    ...
    container_active: 'form-border-color-primary bg-gray-500 bg-opacity-20',
    container_enabled: '',
  ...
  FilePreview: {
    ...
    upload: 'form-bg-primary text-white form-rounded text-xs py-0.5 px-1.5 ml-1.5 whitespace-nowrap transition-transform transform hover:scale-105 focus:form-ring',
  ...
  FilePreview_gallery: {
    ...
    upload: 'relative z-1 form-bg-primary text-white form-small-rounded text-xs py-0.5 px-1.5 whitespace-nowrap transition-transform transform hover:scale-105 focus:form-ring',
  ...
  FilePreview_image: {
    ...
    actions: 'flex items-center',
    percent: 'flex justify-between items-center text-sm text-gray-500 group-hover:form-hidden',
    upload: 'form-bg-primary text-white form-small-rounded text-xs py-0.5 px-1.5 ml-1.5 whitespace-nowrap transition-transform transform hover:scale-105 focus:form-ring',
