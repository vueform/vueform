...
const checkbox = {
  input: 'flex-shrink-0 appearance-none duration-200 ease-in-out cursor-pointer outline-zero transition-shadow transition-colors border-solid form-border-checkbox form-border-color-input form-bg-input checked:form-bg-icon-check focus:form-ring',
  ...
  input_sm: 'form-w-checkbox-sm form-h-checkbox-sm form-rounded-checkbox-sm form-mr-space-checkbox-sm',
  input_md: 'form-w-checkbox form-h-checkbox form-rounded-checkbox form-mr-space-checkbox',
  input_lg: 'form-w-checkbox-lg form-h-checkbox-lg form-rounded-checkbox-lg form-mr-space-checkbox-lg',
...
const radio = {
  input: 'flex items-center justify-center flex-shrink-0 appearance-none duration-200 ease-in-out cursor-pointer rounded-full outline-zero transition-shadow transition-colors border-solid form-border-radio form-border-color-input form-bg-input checked:form-bg-icon-radio focus:form-ring',
  input_enabled: ' hover:form-shadow-input-hover hover:form-border-color-input-hover hover:form-bg-input-hover focus:form-shadow-input-focus checked:form-bg-primary checked:form-border-color-checked',
  input_disabled: 'form-bg-disabled form-border-color-input',
  input_danger: 'not-checked:form-border-color-input-danger not-checked:form-bg-input-danger',
...
const text = {
  container: '',
  inputContainer: 'w-full flex flex-1 transition-colors transition-shadow border-solid form-border-input form-shadow-input form-input-group group',
...
export default {
  ...
  TagsElement: {
    ...
    select: {
      ...
      tag: 'form-bg-tag form-color-tag form-border-tag form-border-color-tag font-semibold  flex items-center whitespace-nowrap',
      tag_sm: 'form-rounded-tag-sm form-text-small-sm form-py-tag-sm form-pl-tag-sm form-mr-space-tags-sm form-mb-space-tags-sm',
      tag_md: 'form-rounded-tag form-text-small form-py-tag form-pl-tag form-mr-space-tags form-mb-space-tags',
      tag_lg: 'form-rounded-tag-lg form-text-small-lg form-py-tag-lg form-pl-tag-lg form-mr-space-tags-lg form-mb-space-tags-lg',
  ...
  ElementLabelFloating: {
    ...
    label: 'absolute z-10 leading-px text-0.5xs px-px transition whitespace-nowrap form-color-muted in-input-group:-form-top-border-width-input-t',
