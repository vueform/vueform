...
const radio = {
  ...
  input_disabled: 'form-bg-disabled form-border-color-disabled',
  input_danger: 'form-border-color-input-danger',
  input_sm: 'form-w-radio-sm form-h-radio-sm',
  input_md: 'form-w-radio form-h-radio',
  input_lg: 'form-w-radio-lg form-h-radio-lg',
  $input: (classes, { isDisabled, Size, isDanger }) => ([
    classes.input,
    classes[`input_${Size}`],
    isDisabled ? classes.input_disabled : classes.input_enabled,
...
export default {
  ...
  SliderElement: {
    ...
    slider: {
      ...
      handle: 'absolute rounded-full form-bg-slider-handle border-0 form-shadow-slider-handle cursor-grab hover:form-shadow-input-hover focus:form-shadow-input-focus focus:outline-zero h:w-4 h:h-4 h:-top-1.5 h:-right-2 txt-rtl-h:-left-2 txt-rtl-h:right-auto v:w-4 v:h-4 v:-bottom-2 v:-right-1.25 focus:form-ring disabled:cursor-not-allowed',
  ...
  ToggleElement: {
    ...
    text: 'ml-2',
    toggle: {
      container: 'form-shadow-input inline-block rounded-full outline-zero focus:form-ring',
      container_enabled: 'transition-shadows hover:form-shadow-input-hover focus:form-shadow-input-focus',
