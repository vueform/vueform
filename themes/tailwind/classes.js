...
export default {
  ...
  SignatureElement: {
    container: '',
    wrapper: 'transition-input form-border-width-input form-radius-large form-text relative w-full',
    wrapper_disabled: 'form-bg-disabled form-color-disabled form-border-color-input cursor-not-allowed pointer-events-none',
    wrapper_enabled: 'form-bg-input form-color-input form-border-color-input',
    wrapper_readonly: 'pointer-events-none',
    line: 'absolute top-1/2 left-6 right-6 border-gray-300',
    ...
    input: 'bg-transparent absolute top-1/2 left-0 right-0 transform -translate-y-1/2 pr-9 text-center indent-9 transition-colors h-[8.5rem]',
    placeholder: 'absolute left-0 right-0 bottom-[50%] transform translate-y-1/2 pointer-events-none text-gray-400 text-center',
    ...
    color: 'transform transition-transform cursor-pointer',
    color_invert: 'dark:filter dark:invert',
    color_active: 'scale-[1.4]',
    color_inactive: 'hover:scale-[1.4]',
    actions: 'absolute top-2 left-3 right-3 flex items-center justify-between opacity-50 transition-opacity hover:opacity-100',
    undosWrapper: 'absolute right-3 top-3 flex items-center justify-center gap-3',
    undo: 'mask-bg mask-form-trix-undo form-bg-icon w-3 h-3',
    undo_enabled: 'cursor-pointer',
    undo_disabled: 'opacity-50 cursor-not-allowed',
    redo: 'mask-bg mask-form-trix-redo form-bg-icon w-3 h-3',
    redo_enabled: 'cursor-pointer',
    redo_disabled: 'opacity-50 cursor-not-allowed',
    clearWrapper: 'absolute top-1/2 transform -translate-y-1/2 right-4 text-sm text-gray-900',
    clear: 'mask-bg mask-form-remove bg-gray-900 w-3 h-4 py-px box-content inline-block cursor-pointer',
    $wrapper: (classes, { isDisabled, readonly }) => ([
      classes.wrapper,
    ...
    $color: (classes, { color, invertColors }) => (c) => ([
      classes.color,
      c === color ? classes.color_active : classes.color_inactive,
      invertColors.indexOf(c) !== -1 ? classes.color_invert : null,
    ]),
