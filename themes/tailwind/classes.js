...
const text = {
  ...
  input_disabled: 'form-bg-disabled form-color-disabled form-border-color-input',
  ...
  input_sm: 'form-p-input-sm form-rounded-sm form-text-sm form-h-input-height-sm',
  input_md: 'form-p-input form-rounded form-text form-h-input-height',
  input_lg: 'form-p-input-lg form-rounded-lg form-text-lg form-h-input-height-lg with-floating:form-p-input-floating-lg',
...
const select = {
  ...
  container_sm: 'form-text-sm form-rounded-sm form-h-input-height-sm',
  container_md: 'form-text form-rounded form-h-input-height',
  container_lg: 'form-text-lg form-rounded-lg form-h-input-height-lg',
  containerDisabled: '',
...
export default {
  ...
  GroupElement: {
    container: '',
    wrapper: 'grid grid-cols-12 form-gap-x-gutter',
  },
  ListElement: {
    container: '',
    list: '',
    ...
    add_sm: 'form-rounded-small-sm form-text-small-sm form-p-btn-small-sm',
    add_md: 'form-rounded-small form-text-small form-p-btn-small',
    add_lg: 'form-rounded-small-lg form-text-small-lg form-p-btn-small-lg',
  ...
  MultifileElement: {
    ...
    button_disabled: 'opacity-50 cursor-not-allowed',
    button_sm: 'form-mb-0.5gutter-sm form-p-btn-sm form-rounded-btn-sm form-text-sm',
    button_md: 'form-mb-0.5gutter form-p-btn form-rounded-btn form-text',
    button_lg: 'form-mb-0.5gutter-lg form-p-btn-lg form-rounded-btn-lg form-text-lg',
  ...
  // Components
  ElementAddon: {
    container: 'border-solid form-border-input form-border-color-input form-bg-addon form-color-addon flex items-center',
  ...
  ElementLayout: {
    ...
    outerWrapper: 'grid grid-cols-12 form-gap-x-gutter',
    outerWrapper_single: '',
  ...
  FormElements: {
    container: 'grid grid-cols-12 form-gap-x-gutter'
  },
  FormErrors: {
    container: 'form-bg-danger form-color-danger py-3 px-5 rounded',
    container_sm: 'form-rounded-sm form-text-sm form-mb-gutter-sm',
    container_md: 'form-rounded form-text form-mb-gutter',
    container_lg: 'form-rounded-lg form-text-lg form-mb-gutter-lg',
    error: '',
    $container: (classes, { Size }) => ([
      classes.container,
      classes[`container_${Size}`],
  ...
  FormMessages: {
    container: 'form-bg-success form-color-success py-3 px-5',
    container_sm: 'form-rounded-sm form-text-sm form-mb-gutter-sm',
    container_md: 'form-rounded form-text form-mb-gutter',
    container_lg: 'form-rounded-lg form-text-lg form-mb-gutter-lg',
    message: '',
  ...
  FormStepsControl: {
    ...
    button_sm: 'form-p-btn-sm form-rounded-btn-sm',
    button_md: 'form-p-btn form-rounded-btn',
    button_lg: 'form-p-btn-lg form-rounded-btn-lg',
