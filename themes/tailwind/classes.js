...
const checkbox = {
  input: 'flex-shrink-0 appearance-none duration-200 ease-in-out cursor-pointer mr-1.5 outline-zero transition-all border-solid form-border-checkbox checked:form-bg-icon-check',
  input_enabled: 'checked:form-bg-primary checked:form-border-color-checked hover:form-shadow-input-hover focus:form-shadow-input-focus ',
  input_disabled: 'form-bg-disabled form-border-color-disabled',
  input_danger: 'form-border-color-input-danger',
...
const radio = {
  input: 'flex-shrink-0 appearance-none duration-200 ease-in-out cursor-pointer rounded-full mr-1.5 outline-zero transition-all border-solid form-border-radio checked:form-bg-icon-radio',
  input_enabled: 'checked:form-bg-primary checked:form-border-color-checked hover:form-shadow-input-hover focus:form-shadow-input-focus',
  input_disabled: 'form-bg-disabled form-border-color-disabled',
  input_danger: 'form-border-color-input-danger',
...
const text = {
  container: '',
  input: 'w-full z-1 transition-colors transition-shadow addon-before:form-rounded-l-none addon-after:form-rounded-r-none border-solid form-border-input form-shadow-input',
  ...
  inputContainer: 'w-full flex form-shadow-input',
...
const select = {
  ...
  container_disabled: 'form-bg-disabled form-color-disabled',
  ...
  dropdown: 'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full form-border-dropdown border-solid form-border-color-input -mt-px overflow-y-scroll z-50 flex flex-col',
  ...
  group: 'p-0 m-0',
  groupLabel: 'flex text-sm box-border items-center justify-start text-left py-1 font-semibold form-bg-selected form-color-input filter brightness-90 cursor-default',
...
const groupTabs = {
  ...
  wrapper: 'flex items-center justify-center form-border-input border-solid py-1.5 w-full',
  wrapper_not_last: '!border-r-0',
  wrapper_first: '',
  wrapper_first_sm: 'form-rounded-large-l-sm',
  wrapper_first_md: 'form-rounded-large-l',
  wrapper_first_lg: 'form-rounded-large-l-lg',
  wrapper_last: '',
  wrapper_last_sm: 'form-rounded-large-r-sm',
  wrapper_last_md: 'form-rounded-large-r',
  wrapper_last_lg: 'form-rounded-large-r-lg',
...
const groupBlocks = {
  container: 'flex align-start cursor-pointer',
  wrapper: 'flex items-center form-border-input border-solid w-full px-4 py-3 form-border-color-input',
...
export default {
  ...
  ButtonElement: {
    ...
    button_enabled: 'cursor-pointer transition-transform focus:form-ring transform hover:scale-105',
    ...
    button_sm: 'form-p-button-sm form-rounded-btn-sm form-text-sm',
    button_md: 'form-p-button form-rounded-btn form-text',
    button_lg: 'form-p-button-lg form-rounded-btn-lg form-text-lg',
  ...
  ListElement: {
    ...
    add: 'inline-block form-bg-primary form-border-btn form-border-color-primary form-color-on-primary form-shadow-btn transition-transform transform hover:scale-105 focus:form-ring',
    add_sm: 'form-rounded-small-sm form-text-small-sm px-2.5 py-1',
    add_md: 'form-rounded-small form-text-small px-2.5 py-1',
    add_lg: 'form-rounded-small-lg form-text-small-lg px-3 py-1.5',
  ...
  MultifileElement: {
    ...
    button_disabled: 'opacity-50 cursor-not-allowed',
    button_sm: 'form-mb-0.5gutter-sm form-p-button-sm form-rounded-btn-sm form-text-sm',
    button_md: 'form-mb-0.5gutter form-p-button form-rounded-btn form-text',
    button_lg: 'form-mb-0.5gutter-lg form-p-button-lg form-rounded-btn-lg form-text-lg',
  ...
  SliderElement: {
    ...
    slider: {
      ...
      vertical: 'slider-vertical form-w-slider-vertical h-80',
  ...
  TagsElement: {
    ...
    select: {
      ...
      tag_sm: 'form-rounded-tag-sm form-text-small-sm',
      tag_md: 'form-rounded-tag form-text-small',
      tag_lg: 'form-rounded-tag-lg. form-text-small-lg',
  ...
  ToggleElement: {
    ...
    text: 'ml-2',
    toggle: {
      container: 'form-shadow-input inline-block rounded-full outline-zero transition-shadows focus:form-ring',
  ...
  // Components
  ElementAddon: {
    container: 'form-border-input border-solid form-border-color-input form-bg-addon form-color-addon flex items-center',
  ...
  ElementLabelFloating: {
    ...
    label: 'absolute z-10 leading-px text-0.5xs px-px transition whitespace-nowrap form-color-muted ',
  ...
  FormStepsControl: {
    ...
    button_sm: 'form-p-button-sm form-rounded-btn-sm',
    button_md: 'form-p-button form-rounded-btn',
    button_lg: 'form-p-button-lg form-rounded-btn-lg',
  ...
  DragAndDrop: {
    container: 'form-shadow-input w-full form-bg-input form-color-input form-border-input border-solid border-dashed transition inline-flex flex-col items-center justify-center p-6 cursor-pointer',
    container_sm: 'form-rounded-large-sm form-text-sm',
    container_md: 'form-rounded-large form-text',
    container_lg: 'form-rounded-large-lg form-text-lg',
  ...
  FilePreview_image: {
    ...
    image_link: '',
    image_static: '',
    image_sm: 'form-rounded-image-sm form-text-sm',
    image_md: 'form-rounded-image form-text',
    image_lg: 'form-rounded-image-lg form-text-lg',
