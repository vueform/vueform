...
export default {
  ...
  SignatureElement: {
    ...
    dndText: 'text-dark-700 dark:text-dark-200',
    ...
    undo: 'mask-bg mask-form-trix-undo form-bg-icon w-3 h-3 dark:bg-dark-300',
    undo_enabled: 'cursor-pointer',
    undo_disabled: 'opacity-50 cursor-not-allowed',
    redo: 'mask-bg mask-form-trix-redo form-bg-icon w-3 h-3 dark:bg-dark-300',
    ...
    clear: 'mask-bg mask-form-remove bg-gray-900 w-3 h-4 py-px box-content inline-block cursor-pointer dark:bg-dark-100',
