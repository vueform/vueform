...
function useModel (props, context, dependencies) {
  ...
  var externalValue = $this.$vueform.vueVersion === 3 ? mv : v; // ================ DATA =================
...
var base$14 = function base(props, context) {
  var {
    schema,
    tabs,
    steps,
  ...
  */
  ...
  var mounted = ref(false); // ============== COMPUTED ==============
  ...
  */
  ...
  onMounted(() => {
    mounted.value = true; // Watching model to track old/new values
...
var base$10 = function base(props, context, dependencies) {
  ...
  */
  ...
  var ViewInject = inject('View', ref(undefined)); // ============== COMPUTED ==============
...
var base$$ = function base(props, context, dependencies) {
  ...
  var {
    View
  } = base$10(props, context); // ============== COMPUTED ===============
...
var base$_ = function base(props, context, dependencies) {
  ...
  var el$ = dependencies.el$ || ref(undefined); // ================ DATA ================
...
var FormTab = {
  ...
  setup(props, context) {
    ...
    var tabLabel = ref(tabLabel_.value && typeof tabLabel_.value === 'object' ? markRaw(tabLabel_.value) : tabLabel_.value); // ============== COMPUTED ==============
...
var ElementInfo = {
  ...
  setup(props, context) {
    ...
    var position = ref(el$.value.infoPosition); // ============== COMPUTED ==============
...
var object$6 = function object(props, context, dependencies) {
  ...
  var fire = dependencies.fire;
  var value = dependencies.value;
  var el$ = dependencies.el$; // ============== WATCHERS ===============
...
var multifile$4 = list$3;
var group$6 = object$6;

var base$U = function base(props, context) {
  var options_ = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  // =============== INJECT ===============
  var deps = options_.deps || {};

  var options = _objectSpread2$1(_objectSpread2$1({}, options_), {}, {
    events: context.emits,
    slots: context.slots
  });
...
var base$R = function base(props, context, dependencies) {
  ...
  var form$ = dependencies.form$;
  var parent = dependencies.parent; // ================ DATA ================
...
var base$P = function base(props, context, dependencies) {
  ...
  var fieldSlots = computed(() => {
    ...
    defaultFieldSlots.filter(s => options.slots.indexOf(s) !== -1).forEach(s => {
      var slot = el$.value.slots[s] || el$.value.slots[_.camelCase(s)]; // Add `el$` prop to `default` slot
...
var base$M = function base(props, context, dependencies) {
  ...
  var View = dependencies.View; // ============== COMPUTED ==============
...
var list$2 = function list(props, context, dependencies) {
  var {
    ...
    activate,
    deactivate
  } = base$I(props, context, dependencies); // ============== COMPUTED ==============
...
var group$5 = function group(props, context, dependencies) {
  ...
  var {
    path,
    parent
  } = base$H(props, context, dependencies); // ============== COMPUTED ==============
...
var ButtonElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, static_, base$15, static_$1, button, base$_, base$T, base$R, base$Q, base$L, base$O, base$M, base$S, base$P];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'default'];
    context.watchValue = false;
    context.initValidation = false;
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var object$5 = function object(props, context, dependencies) {
  ...
  var {
    data,
    prepare
  } = base$F(props, context, dependencies); // ============ DEPENDENCIES =============
...
var group$4 = function group(props, context, dependencies) {
  ...
  var {
    ...
    reset,
    prepare
  } = object$5(props, context, dependencies); // ============ DEPENDENCIES =============
...
var list$1 = function list(props, context, dependencies, options) {
  ...
  var initialValue = ref(_.get(form$.value.model, dataPath.value)); // ============== COMPUTED ===============
...
var multilingual$6 = function multilingual(props, context, dependencies) {
  ...
  var {
    ...
    reset,
    prepare
  } = base$F(props, context, dependencies, options); // ============ DEPENDENCIES =============
...
var text = function text(props, context, dependencies) {
  var {
    ...
    initMessageBag,
    initValidation
  } = base$D(props, context, dependencies); // ============== COMPUTED ===============
...
var multilingual$4 = function multilingual(props, context, dependencies) {
  ...
  var {
    messageBag
  } = text(props, context, dependencies); // ================ DATA ================
...
var object$3 = function object(props, context, dependencies) {
  ...
  var validate = /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator(function* () {
      yield asyncForEach(children$.value, /*#__PURE__*/function () {
        var _ref13 = _asyncToGenerator(function* (element$) {
          if (!element$.available || element$.isStatic) {
            return;
          }
...
var slider$1 = function slider(props, context, dependencies) {
  ...
  var {
    ...
    initMessageBag,
    initValidation
  } = base$D(props, context, dependencies); // =============== METHODS ==============
    ...
    var _ref14 = _asyncToGenerator(function* () {
      ...
      if (_.isArray(value.value)) {
        ...
        yield asyncForEach(value.value, /*#__PURE__*/function () {
          var _ref15 = _asyncToGenerator(function* (val) {
            yield asyncForEach(Validators.value, /*#__PURE__*/function () {
              var _ref16 = _asyncToGenerator(function* (Validator) {
...
var location$1 = function location(props, context, dependencies) {
  ...
  var {
    ...
    initMessageBag,
    initValidation
  } = text(props, context, dependencies); // =============== METHODS ==============
  ...
  var validate = /*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator(function* () {
      ...
      yield asyncForEach(Validators.value, /*#__PURE__*/function () {
        var _ref21 = _asyncToGenerator(function* (Validator) {
...
var multilingual$3 = function multilingual(props, context, dependencies) {
  var {
    value
  } = base$B(props, context, dependencies); // ============ DEPENDENCIES =============
...
var date$2 = function date(props, context, dependencies) {
  ...
  var defaultValue = dependencies.defaultValue;
  var dataPath = dependencies.dataPath;
  var form$ = dependencies.form$; // ================= PRE =================
...
var CheckboxElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, boolean, base$L, base$15, base$I, base$E, base$_, base$D, base$B, base$F, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, checkbox];
...
var base$y = function base(props, context, dependencies) {
  // ============ DEPENDENCIES ============
  var value = dependencies.value;
  var resolvedOptions = dependencies.resolvedOptions; // =============== METHODS ==============
  ...
  var createAsyncOptionsFromUrl = () => {
    return /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator(function* (query) {
        ...
        var optionList = ((_yield$form$$value$$v2 = yield form$.value.$vueform.services.axios.get("".concat(items.value, "?").concat(searchParam.value, "=").concat(query || ''))) === null || _yield$form$$value$$v2 === void 0 ? void 0 : _yield$form$$value$$v2.data) || [];
...
var CheckboxgroupElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$H, array$1, base$L, base$15, checkboxgroup$1, checkboxgroup$2, checkboxgroup, base$E, base$_, base$D, base$B, base$y, base$F, base$T, base$C, base$S, base$R, base$Q, base$M, base$P];
...
var dates$1 = function dates(props, context, dependencies) {
  ...
  var {
    ...
    maxDate,
    disabledDates
  } = date$1(props, context, dependencies); // ============ DEPENDENCIES ============
...
var select = function select(props, context, dependencies) {
  // ============ DEPENDENCIES ============
  var input = dependencies.input;
  var isNative = dependencies.isNative; // ================ DATA ================
...
var DateElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$L, base$s, base$15, base$I, base$w, base$u, date$1, base$E, base$_, base$D, date$2, date$3, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$t, date];
...
var DatesElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, array$1, base$L, base$s, base$15, dates$5, base$w, dates$2, dates$1, base$E, dates$3, base$_, base$D, dates$4, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$t, dates];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var base$o = function base(props, context, dependencies) {
  ...
  var update = dependencies.update;
  var isDisabled = dependencies.isDisabled;
  var uploadTemp = dependencies.uploadTemp; // ============== COMPUTED ==============
...
var multifile$3 = function multifile(props, context, dependencies) {
  ...
  var {
    canDrop
  } = base$o(props, context, dependencies); // ============ DEPENDENCIES =============
...
var FileElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$n, base$L, base$15, file$2, base$p, base$E, base$_, base$B, file$1, base$F, base$m, base$q, base$o, base$v, base$T, file, base$R, base$Q, base$M, base$S, base$P];
...
var GroupElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, group$5, object$1, base$15, base$I, group, group$3, base$T, group$2, group$1, base$Y, base$_, base$R, base$Q, base$M, base$S, base$P, group$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    context.watchValue = false;
    context.initValidation = false;
    var element = base$U(props, context);
    group$6(props, context, element);
    onMounted(() => {
      element.initMessageBag();
    });
    return _objectSpread2$1({}, element);
  }
...
var HiddenElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$G, base$H, base$A, base$C, base$L, base$Q, base$15, base$I, base$E, base$_, base$D, base$B, base$F, base$v];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var multifile$2 = function multifile(props, context, dependencies, options) {
  ...
  var {
    refreshOrderStore
  } = base$i(props, context, dependencies); // =============== METHODS ==============
...
var ListElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$H, base$K, array$1, base$h, base$l, base$j, base$i, base$15, list$2, base$E, base$T, base$C, base$Y, base$_, list, base$B, base$g, array, base$S, base$R, base$Q, base$M, base$P, list$1, base$k];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    context.watchValue = false;
    var element = base$U(props, context, {
      init: false
    });
    list$3(props, context, element);
    return _objectSpread2$1({}, element);
  }
...
var base$f = function base(props, context, dependencies) {
  ...
  var input = dependencies.input; // ============== PRIVATE ===============
...
var LocationElement = {
  ...
  setup(props, context) {
    ...
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, location, base$L, base$s, base$15, base$I, base$w, base$E, base$B, location$1, base$_, base$F, base$f, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$r];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    context.watchValue = false;
    var element = base$U(props, context);
    onMounted(() => {
    ...
    location$2(props, context, element);
    return _objectSpread2$1({}, element);
  }
...
var MultifileElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$H, base$K, array$1, base$l, base$G, base$j, multifile$1, base$15, list$2, base$E, base$T, base$C, list, base$B, array, base$Y, base$_, base$S, base$R, base$Q, base$P, multifile$2, list$1, base$e, multifile, multifile$3, base$M, base$k];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    context.watchValue = false;
    var element = base$U(props, context);
    multifile$4(props, context, element);
    return _objectSpread2$1({}, element);
  }
...
var base$d = function base(props, context, dependencies) {
  // ============ DEPENDENCIES ============
  var fire = dependencies.fire;
  var el$ = dependencies.el$; // =============== METHODS ==============
  ...
  var handleTag = searchQuery => {// unimplemented
  }; // =============== HOOKS ================
...
var MultiselectElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, array$1, base$L, base$s, base$15, multiselect$2, base$E, base$D, base$b, multiselect$1, base$x, base$B, base$_, base$F, array, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$d, base$c, multiselect];
...
var ObjectElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$H, object$1, base$15, base$I, object$4, object$2, base$T, object, base$Y, base$_, object$3, base$R, base$Q, base$M, base$S, base$P, object$5];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    context.watchValue = false;
    context.initValidation = false;
    var element = base$U(props, context);
    object$6(props, context, element);
    onMounted(() => {
      element.initMessageBag();
    });
    return _objectSpread2$1({}, element);
...
var RadioElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$L, base$15, base$I, base$A, base$E, base$_, base$D, base$B, base$F, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$a];
    context.slots = ['default', 'label', 'info', 'description', 'before', 'between', 'after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var RadiogroupElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$H, base$A, base$L, base$15, base$I, radiogroup$1, radiogroup, base$E, base$_, base$D, base$B, base$F, base$T, base$C, base$R, base$Q, base$M, base$S, base$P];
...
var SelectElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$L, base$s, base$15, base$I, base$E, base$D, base$b, select$1, base$x, base$B, base$_, base$F, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$d, select];
...
var SliderElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, min, base$L, base$15, base$I, slider, base$E, base$B, slider$1, base$_, base$F, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$t, base$9];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var StaticElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, static_, base$8, base$15, static_$1, base$_, base$T, base$R, base$Q, base$M, base$S, base$P];
    context.slots = ['default', 'label', 'info', 'description', 'before', 'between', 'after'];
    context.watchValue = false;
    context.initValidation = false;
    return _objectSpread2$1({}, base$U(props, context));
...
var TagsElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, array$1, base$L, base$s, base$15, tags$2, base$E, base$D, base$b, tags$1, base$x, base$B, base$_, base$F, array, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$d, base$7, base$c, tags];
...
var multilingual = function multilingual(props, context, dependencies) {
  var {
    autosize
  } = base$5(props, context, dependencies); // ============ DEPENDENCIES ============
...
var TextareaElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$L, base$s, base$15, base$I, base$w, base$E, base$_, text, base$B, base$F, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$6, base$5, base$r, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var TextElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$L, base$s, base$15, base$I, base$w, base$E, base$_, text, base$b, base$B, base$F, base$v, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$6, base$r, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var ToggleElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, boolean, base$L, base$15, base$I, toggle, base$E, base$_, base$D, base$B, base$F, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$t, base$z];
    context.slots = ['default', 'label', 'info', 'description', 'before', 'between', 'after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var EditorElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$A, base$L, base$15, base$I, base$E, base$_, text, base$B, editor, base$v, base$T, base$C, base$R, base$Q, base$3, base$M, base$S, base$P, base$6, base$2, base$m, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    return _objectSpread2$1({}, base$U(props, context));
  }
...
var TTextareaElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$L, base$s, base$15, base$I, base$w, base$1, multilingual$2, multilingual$5, multilingual$3, base$_, multilingual$4, multilingual$6, multilingual$1, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$6, multilingual, base$r, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    context.watchValue = false;
    context.initValidation = false;
    var element = base$U(props, context);
    multilingual$7(props, context, element);
    onMounted(() => {
      element.initState();
      element.initMessageBag();
...
var TTextElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$L, base$s, base$15, base$I, base$w, base$1, multilingual$2, multilingual$5, multilingual$3, base$_, multilingual$4, base$b, multilingual$6, multilingual$1, base$T, base$C, base$R, base$Q, base$M, base$S, base$P, base$6, base$r, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after', 'addon-before', 'addon-after'];
    context.watchValue = false;
    context.initValidation = false;
    var element = base$U(props, context);
...
var TEditorElement = {
  ...
  setup(props, context) {
    context.features = [base$13, base$12, base$N, base$G, base$H, base$K, base$L, base$15, base$I, base$1, multilingual$2, multilingual$5, multilingual$3, base$_, multilingual$4, teditor, multilingual$1, base$T, base$C, base$R, base$Q, base$3, base$M, base$S, base$P, base$6, base$2, base$m, base$4];
    context.slots = ['label', 'info', 'description', 'before', 'between', 'after'];
    context.initValidation = false;
    context.watchValue = false;
    var element = base$U(props, context);
...
var Validator = class {
  ...
  validate() {
    ...
    return _asyncToGenerator(function* () {
      var value = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this.element$.value;
...
export { Validator, Vueform, index as components, config, base$14 as useVueform };
