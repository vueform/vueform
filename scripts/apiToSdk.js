...
const apiDir = path.resolve(`${__dirname}/../../vueform.com/apps/sdk/src/content/reference`)
const outputDir = path.resolve(`${__dirname}/../../vueform.com/apps/sdk/src/content-partials/reference/generated`)
