<template>
  ...
  <!-- Default layout -->
  <div v-if="layout != 'inline'" :class="[el$.columns.classes.element, theme.classes.elementContainer, {[theme.classes.elementHasValue]: !el$.empty}, el$.elementClass, {[theme.classes.elementHasError]: el$.error}]" v-show="el$.visible">
      ...
      <div :class="[theme.classes.elementInner]">
        <div :class="[el$.columns.classes.label, theme.classes.labelContainer]" v-if="el$.hasLabel">
          ...
          <slot name="info">
            ...
            <component v-else-if="el$.info" :is="theme.components.ElementInfo" :el$="el$"/>
          </slot>
        </div>
  ...
  <!-- Inline layout -->
  <div v-else :class="[theme.classes.element, el$.elementClass, {[theme.classes.elementHasValue]: !el$.empty}, {[theme.classes.elementHasError]: el$.error}]" v-show="el$.visible">
    <slot name="label">
      <component v-if="el$.slots.label" :is="el$.slots.label" :el$="el$"/>
      <component v-else :is="theme.components.ElementLabel" :for="el$.id" v-html="el$.label"/>
    </slot>
